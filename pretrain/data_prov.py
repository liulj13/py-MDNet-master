...
class RegionDataset(data.Dataset):  # parent is torch.utils.data.Dataset!
    ...
    next = __next__  # __next__ is for python3 while next is for python2
    # __XX__ means we shouldn't call it, it is called by python automatically
